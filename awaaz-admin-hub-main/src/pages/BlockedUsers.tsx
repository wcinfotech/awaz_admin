...
import { Search, Users, UserCheck, Eye } from "lucide-react";
...
const BlockedUsers: React.FC = () => {
    ...
    // Fetch all app users (we'll filter for blocked ones)
    ...
    // Filter for blocked users only
    const blockedUsers = useMemo(() => {
        return users.filter((user: AppUser) => user.isBlocked);
    }, [users]);
    ...
    const filteredBlockedUsers = useMemo(() => {
        ...
        return blockedUsers.filter((user: AppUser) =>
    ...
    const handleUnblock = (user: AppUser) => {
        ...
        <AdminLayout title="Blocked Users">
            <div className="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-white/60 mt-2">View and manage blocked application users</p>
                </div>
                ...
                <Card className="bg-card/50 border-border/50">
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-white/60 text-sm">Total Blocked Users</p>
                ...
                <Card className="bg-card/50 border-border/50">
                    <CardContent className="p-4">
                        <div className="relative">
                            ...
                            <Input
                                placeholder="Search blocked users by name, email, or mobile..."
                                value={searchTerm}
                ...
                <Card className="bg-card/50 border-border/50">
                    <CardHeader>
                        <CardTitle className="text-white">Blocked Users ({filteredBlockedUsers.length})</CardTitle>
                    </CardHeader>
                    <CardContent>
                        {isLoading ? (
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-white/60">
                                    {searchTerm ? "No blocked users found matching your search" : "No blocked users found"}
                                </p>
                            </div>
                        ) : (
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {filteredBlockedUsers.map((user: AppUser) => (
